...
namespace OutOfPhase
{
    static class CommandMapping
    {
        ...
        private static readonly KeyValuePair<int, NoteCommands>[] FromFileIDMapping = new KeyValuePair<int, NoteCommands>[]
	    {
		    ...
		    new KeyValuePair<int, NoteCommands>(692, NoteCommands.eCmdSetFrequencyValue),
		    new KeyValuePair<int, NoteCommands>(693, NoteCommands.eCmdAdjustFrequencyValue),
        ...
        private static readonly KeyValuePair<NoteCommands, int>[] ToFileIDMapping = new KeyValuePair<NoteCommands, int>[]
	    {
		    ...
		    new KeyValuePair<NoteCommands, int>(NoteCommands.eCmdSetFrequencyValue, 692),
		    new KeyValuePair<NoteCommands, int>(NoteCommands.eCmdAdjustFrequencyValue, 693),
