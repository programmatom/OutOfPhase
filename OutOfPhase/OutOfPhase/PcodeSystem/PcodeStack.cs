...
namespace OutOfPhase
{
    ...
    public class ArrayHandleByte : ArrayHandle
    {
        ...
        public static readonly ArrayHandleByte Nullish = new ArrayHandleByte(new byte[0]);
        ...
        public override void Resize(int newLength)
        {
            if (this == Nullish)
            {
                throw new NullReferenceException(); // converts into EvalErrors.eEvalArrayDoesntExist
            }
    ...
    public class ArrayHandleInt32 : ArrayHandle
    {
        ...
        public static readonly ArrayHandleInt32 Nullish = new ArrayHandleInt32(new int[0]);
    ...
    public class ArrayHandleFloat : ArrayHandle
    {
        ...
        public static readonly ArrayHandleFloat Nullish = new ArrayHandleFloat(new float[0]);
    ...
    public class ArrayHandleDouble : ArrayHandle
    {
        ...
        public static readonly ArrayHandleDouble Nullish = new ArrayHandleDouble(new double[0]);
    ...
    public struct StackElement
    {
        ...
        // stored consecutively. (In the original C code, these were co-located in an untagged union
        // and correct access was ensured by type-safe code generated by the pcode compiler.)
